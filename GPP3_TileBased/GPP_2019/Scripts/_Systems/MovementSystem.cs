...
namespace GPP_2019
{
    class MovementSystem : ISystem
    {
        ...
        private void UpdateMoveables()
        {
            ...
            {
                if (vc.GameObject.ContainsComponent<InputComponent>())
                {
        ...
        public void Update()
        {
            ...
            {
                InputComponent tmpInput = moveable.GetComponent<InputComponent>();
                VelocityComponent velocity = moveable.GetComponent<VelocityComponent>();
